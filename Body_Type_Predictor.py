...
class format_data:
    ...
    def best_model(self, data, labels, test_percent=0.2, max_neighbors=101, print_graph=True):
...
def main():
    ...
    best_classifier, accuracy, best_n = data.best_model(knn_data, knn_labels, print_graph=True)
